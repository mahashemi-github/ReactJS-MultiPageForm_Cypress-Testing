  ...
  return ( 
    <div className="subscription-form">
      <form aria-label="myform" onSubmit={handleSubmit}>
        ...
        />
        <p id="info1" className={focusUsername && !validUsername ? "instructions" : "hideIns"}>
        ...
        <div id="done1" className={validUsername ? "show" : "hide"}>
        ...
        />
        <p id="info2" className={focusEmail && !validEmail ? "instructions" : "hideIns"}>
        <span className="material-symbols-outlined">Info</span>
        ...
        <div id="done2" className={validEmail ? "show" : "hide"}>
        <span className="material-symbols-outlined">Done</span> 
        Valid Email.
        </div>
        ...
        />    
        <p id="info3" className={focusPwd && !validPwd ? "instructions" : "hideIns"}>
        <span className="material-symbols-outlined">Info</span>
        ...
        <div id="done3" className={validPwd ? "show" : "hide"}>
        <span className="material-symbols-outlined">Done</span>
        Valid Password.
        </div>
        ...
        />    
        <div id="done4" className={correctPwdCo ? "show" : "hide"}>
        <span className="material-symbols-outlined">Done</span>
        ...
        <p id="info4" className={focusSele && !optionSelected ? "instructions" : "hideIns"}>
        <span className="material-symbols-outlined">Info</span>
          Required, please select a skill. 
        </p>
        <div  id="done5" className={optionSelected ? "show" : "hide"}>
        <span className="material-symbols-outlined">Done</span> 
        A skill is selected.
        </div>
